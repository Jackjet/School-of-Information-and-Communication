...
public class WeixinUtil {
    ...
    //update-begin--Author:zhaofei  Date: 20191025 for：注释上传图文素材文件方法 新增新的上传方法
    /**
     * 上传多媒体文件
     * @param fileType
     * @param
    ...
    public static JSONObject sendMediaByUrl(String fileType,String url,String token) {
  		...
  		jsonobject = null;
  			...
  			OutputStream out =null;
  			try{
  				String requestUrl="https://file.api.weixin.qq.com/cgi-bin/media/upload?access_token="+ token + "&type="+fileType;
  				log.info("------------------requestUr------------"+requestUrl);
...
//  激活主机认证
	...
	//update-end--Author:zhaofei  Date: 20191025 for：注释上传图文素材文件方法 新增新的上传方法


	//update-begin--Author:zhaofei  Date: 20191025 for：添加url云图片地址转字节方法
	...
	//update-end--Author:zhaofei  Date: 20191025 for：添加url云图片地址转字节方法
...
class TrustAllTrustManager implements javax.net.ssl.TrustManager, javax.net.ssl.X509TrustManager {
