...
public interface MenuTreeMapper {
    ...
    MenuTree dtoFormatIntoInsertEntity(MenuTreeInsertVm insertVm);

    @Mapping(target = "children", ignore = true)
    MenuTreeTree entityFormatIntoDtoTree(MenuTree menuTree);
    ...
    @Mapping(target = "createTime", ignore = true)
    @Mapping(target = "createById", ignore = true)
    void copyProperties(MenuTreeUpdateVm source, @MappingTarget MenuTree target);
}
