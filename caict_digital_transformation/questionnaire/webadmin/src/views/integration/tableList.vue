         ...
         <template slot-scope="scope">
          ...
          <template v-if="index.type === 'imgTxt'">
            <div  style="display: flex;align-items: center;width: 100%">
              ...
              <el-image  v-else
                         style="width: 100px; height: 50px;"
                         fit="fill"
                         :src="require('@/assets/image/errorPic.jpg')">
              </el-image>
          ...
          <template v-else-if="index.type === 'btn'">
            <el-button type="text"
              ...
              <u style="white-space: normal">{{scope.row[index.list]}}</u>
            </el-button>
          </template>
          <!-- 下拉 -->
...
export default {
  ...
  methods: {
    ...
    sortChanged (column, prop, order) {
      this.$emit('sortChanged', column.prop, column.order)
    }
  }
}
</script>
