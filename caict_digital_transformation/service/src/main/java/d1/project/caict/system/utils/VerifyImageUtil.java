package d1.project.caict.system.utils;
...
public class VerifyImageUtil {
    ...
    public static Map<String, Object> pictureTemplatesCut(File templateFile, File targetFile) throws Exception {
        ...
        int bound = oriImageWidth - 2 * templateWidth;
        int widthRandom = random.nextInt(bound) + templateWidth;
        int bound1 = oriImageHeight - templateHeight;
        int heightRandom = random.nextInt(bound1);
