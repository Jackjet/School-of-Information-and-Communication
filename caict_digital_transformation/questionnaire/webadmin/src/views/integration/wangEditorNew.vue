<template>
  <div class="editor">
    ...
    <div :id="editorId.str" :ref="editorId.str" class="text"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    setContentUpload (data, url, file) {
      ...
      console.log(range)
      let d = document.querySelector('#' + this.editorId.str)
    ...
    seteditor () {
      this.editor = new E(this.editorId.str)
