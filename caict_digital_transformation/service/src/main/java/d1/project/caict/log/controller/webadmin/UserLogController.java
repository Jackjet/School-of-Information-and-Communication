...
public class UserLogController {
    ...
    public Result<Page<OperationLog>> findAll(UserLogFindAllVm model, HttpServletRequest request) throws Exception {
        return ResultUtil.success("", userLogService.findAll(model, request));
    }

    @GetMapping(value = "/find")
    public Result<OperationLog> findAll(String id) throws DoValidException {
