...
import d1.project.caict.system.service.OrganizationService;
...
public class OrganizationController {
    ...
    public Result<WebAdminUser> find(String id) {
        return ResultUtil.success("", organizationService.findAllById(id));
    }
