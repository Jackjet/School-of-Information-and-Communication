package d1.project.caict.log.controller.webadmin;
...
import d1.project.caict.log.service.OperationLogServiceImpl;
...
public class OperationLogController {
    ...
    public Result<Page<OperationLog>> findAll(OperationLogFindAllVm model, HttpServletRequest request) throws Exception {
        return ResultUtil.success("", operationLogService.findAll(model, request));
    }

    @GetMapping(value = "/find")
    public Result<OperationLog> find(String id) throws DoValidException {
