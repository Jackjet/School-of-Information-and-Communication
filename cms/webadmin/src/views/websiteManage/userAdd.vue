  ...
  <el-drawer
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  v-loading='loading'>
      <el-form-item
        ...
        class='InpitWidth'>
        <el-input clearable :disabled='ProhibitFromm' autocomplete="off" v-model="ruleForm.realName" placeholder="请输入姓名"></el-input>
      </el-form-item>
      <el-form-item
        prop="name"
        label="账号"
        :label-width="this.formLabelWidth"
        class='InpitWidth'>
        <el-input clearable :disabled='ProhibitFromm' autocomplete="off" v-model="ruleForm.name" placeholder="请输入账号"></el-input>
      </el-form-item>
      <el-form-item
        prop="sex"
        label="性别"
      ...
      <el-form-item
        ...
        :label-width="this.formLabelWidth"
        class='InpitWidth'>
        <el-input clearable :disabled='ProhibitFromm' autocomplete="off" v-model="ruleForm.tel" placeholder="请输入联系电话"></el-input>
      </el-form-item>
      ...
      <el-form-item
        ...
        :label-width="this.formLabelWidth"
        class='InpitWidth'>
        <el-input clearable :disabled='ProhibitFromm' autocomplete="off" v-model="ruleForm.email" placeholder="请输入邮箱"></el-input>
      </el-form-item>
    ...
    <div class="demo-drawer__footer drawer_footer">
      ...
      <el-button :disabled="isAdmin" type="primary" @click="SuretoAddClick('ruleForm')">确 定</el-button>
    </div>
  </el-drawer>
</template>

<script>
import { findUserById,insertUser,updateUser,getRoles } from '@/api/websiteManage'
  ...
  methods: {
    ...
    async initFormDetail (value) {
      ...
      try {
        ...
        that.loading = true
        const response = await findUserById(parameter)
        that.loading = false
